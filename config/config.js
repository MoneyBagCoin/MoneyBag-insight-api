...
var home = process.env.INSIGHT_DB || (getUserHome() + '/.creditbitsight');
...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\creditbit\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/creditbit/';
  if (isLinux) dataDir = process.env.HOME + '/.creditbit/';
}
