...
var genesisTXID = 'a3b080be48c42ce068b699a0464fa786382a66b583d52b601509117519d26fd4';
var CONCURRENCY = 10;
...
var encodedData = require('soop').load('creditbitcore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('creditbitcore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('creditbitcore/lib/Address', {
